...
from mannager_internals.widgets.widget_base import mannagerOption, Input, MultipleHandler, OptionsHandler


class MultipleChoiceInput(Input):
    type = 'multiple-choice-input'

    def __init__(self, key: str, label: str, options: List[mannagerOption],
        **kwargs):
        super().__init__(key)
