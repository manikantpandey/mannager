metadata = {
    "appointment-input": {
        ...
        "examples": [
            {
                "props": {
                    "label": "Welcome to mannager, please select a demo slot",
                    "slots": [
                        {
        ...
        "examples": [
            {
                ...
                "iframeHeight": "208px",
                "key": "example1",
                "code": 'from mannager.forms import read_camera\n\nread_camera("Take a picture of your ID")\n',
            }
        ],
    },
    "cards-input": {
        ...
        "pythonAPI": {
            ...
            "params": [
                ...
                },
                {
                    ...
                    "description": "The initial value to display to the user. Defaults to None.",
                    "typeName": "list",
                    "typeDescription": ["list[mannagerCard]"],
                    "isKwarg": True,
                    "default": "None",
                },
                {
        ...
        "pythonAPI": {
            ...
            "params": [
                ...
                },
                {
                    ...
                    "typeName": "List[mannagerOption]",
                    "typeDescription": ["List[mannagerOption]"],
                    "isKwarg": False,
                    "default": "None",
                },
                {
        ...
        "examples": [
            {
                ...
                "iframeHeight": "142px",
                "key": "example1",
                "code": 'from mannager.forms import read_cnpj\n\nname = read_cnpj("Insert your CNPJ below")\n',
            }
        ],
    },
    "code-input": {
        ...
        "examples": [
            {
                ...
                "iframeHeight": "598px",
                "key": "example1",
                "code": 'from mannager.forms import read_code\n\nans = read_code(\n    "Show me the code!",\n    language="c",\n    initial_value="""\\\n#include<stdio.h>\nint main(int argc, char** argv) {\n  char name[256];\n  scanf("%s", name);\n  printf("%s, here is", name);\n  return 0;\n}""",\n)\n',
            }
        ],
    },
    "cpf-input": {
        ...
        "examples": [
            {
                ...
                "iframeHeight": "142px",
                "key": "example1",
                "code": 'from mannager.forms import read_cpf\n\nname = read_cpf("Insert your CPF below")\n',
            }
        ],
    },
    "currency-input": {
        ...
        "examples": [
            {
                ...
                "iframeHeight": "144px",
                "key": "example1",
                "code": 'from mannager.forms import read_date\n\nbirthday = read_date("When were you born?")\nyear = birthday.year\nmonth = birthday.month\nday = birthday.day\n',
            }
        ],
    },
    "dropdown-input": {
        ...
        "examples": [
            {
                ...
                "iframeHeight": "140px",
                "key": "example1",
                "code": 'from mannager.forms import read_dropdown\n\nans = read_dropdown(\n    "Choose a color",\n    ["Red", "Green", "Blue"],\n)\n# ans = "Red", "Green" or "Blue"\n',
            },
            {
                "props": {
                    "label": "Choose a color",
        ...
        "examples": [
            {
                ...
                "iframeHeight": "142px",
                "key": "example1",
                "code": 'from mannager.forms import read_email\n\nemail = read_email("What is your email?")\n',
            }
        ],
    },
    "file-input": {
    ...
    "nps-input": {
        ...
        "examples": [
            {
                "props": {
                    "label": "How likely are you to recommend mannager Cloud?",
                    "minHint": "No way!",
                    "maxHint": "Hell yeah!",
                },
                "name": "Basic Example",
                ...
                "iframeHeight": "158px",
                "key": "example1",
                "code": 'from mannager.forms import read_nps\n\nans = read_nps(\n    "How likely are you to recommend mannager Cloud?",\n    min_hint="No way!",\n    max_hint="Hell yeah!",\n)\n',
            }
        ],
    },
    "number-input": {
        ...
        "examples": [
            {
                ...
                "iframeHeight": "142px",
                "key": "example1",
                "code": 'from mannager.forms import read_number\n\nage = read_number("How old are you?")\n',
            }
        ],
    },
    "number-slider-input": {
        ...
        "examples": [
            {
                ...
                "iframeHeight": "122px",
                "key": "example1",
                "code": 'from mannager.forms import read_number_slider\n\nage = read_number_slider("Set volume")\n',
            }
        ],
    },
        ...
        "examples": [
            {
                ...
                "iframeHeight": "348px",
                "key": "example1",
                "code": 'import pandas as pd\nfrom mannager.forms import read_pandas_row_selection\n\ndata = [\n    {"Country": "USA", "Population": "32,700,000"},\n    {"Country": "China", "Population": "1,300,000,000"},\n    {"Country": "Japan", "Population": "126,000,000"},\n]\ndf = pd.DataFrame(data)\nread_pandas_row_selection(df)\n',
            }
        ],
    },
    "password-input": {
        ...
        "examples": [
            {
                ...
                "iframeHeight": "142px",
                "key": "example1",
                "code": 'from mannager.forms import read_password\n\nans = read_password("Insert your password below")\n',
            }
        ],
    },
    "phone-input": {
        ...
        "examples": [
            {
                ...
                "iframeHeight": "206px",
                "key": "example1",
                "code": 'from mannager.forms import read_richtext\n\nread_richtext("Write here your bio")\n',
            }
        ],
    },
    "tag-input": {
        ...
        "examples": [
            {
                ...
                "iframeHeight": "142px",
                "key": "example1",
                "code": 'from mannager.forms import read\n\nname = read("What is your name?")\n',
            },
            {
                "props": {
    ...
    "textarea-input": {
        ...
        "examples": [
            {
                "props": {
                    "label": "What kind of things are you building with mannager?",
                    "value": "",
                },
                "name": "Basic Example",
                ...
                "iframeHeight": "164px",
                "key": "example1",
                "code": 'from mannager.forms import read_textarea\n\nans = read_textarea("What kind of things are you building with mannager Cloud?")\n',
            }
        ],
    },
    "time-input": {
        ...
        "examples": [
            {
                ...
                "iframeHeight": "144px",
                "key": "example1",
                "code": 'from mannager.forms import read_time\n\nans = read_time("Select a time below")\n# ans = 00:00:00\n',
            }
        ],
    },
    "toggle-input": {
        ...
        "examples": [
            {
                ...
                "iframeHeight": "124px",
                "key": "example1",
                "code": 'from mannager.forms import read_toggle\n\nans = read_toggle("Toggle")\n# ans = True or False\nprint(ans)\n',
            },
            {
                "props": {
                    "label": "Custom Toggle",
        ...
        "examples": [
            {
                ...
                "iframeHeight": "259px",
                "key": "example1",
                "code": 'from mannager.forms import read_video\n\nfile_response = read_video("Upload your video")\nfile = file_response.file  # File object\n',
            }
        ],
    },
    "file-output": {
        ...
        "examples": [
            {
                ...
                "iframeHeight": "168px",
                "key": "example1",
                "code": 'from mannager.forms import display_html\n\ndisplay_html(\n    \'<svg width="100" height="100"><circle cx="50" cy="50" r="40" stroke="green" stroke-width="4" fill="yellow" /></svg>\'\n)\n',
            }
        ],
    },
    "iframe-output": {
        ...
        "examples": [
            {
                ...
                "iframeHeight": "96px",
                "key": "example1",
                "code": 'from mannager.forms import display_latex\n\ndisplay_latex("\\(ax^2 + bx + c = 0\\)")\n',
            },
            {
                "props": {
    ...
    "link-output": {
        ...
        "examples": [
            {
                "props": {
                    "linkUrl": "https://mannager.io",
                    "linkText": "mannager Homepage",
                },
                "name": "Basic Example",
                "description": "The following example demonstrate some of the available functionality for display_link",
                "iframeHeight": "94px",
                "key": "example1",
                "code": 'from mannager.forms import display_link\n\ndisplay_link("https://mannager.io", link_text="mannager Homepage")\n',
            }
        ],
    },
    "markdown-output": {
        ...
        "examples": [
            {
                ...
                "iframeHeight": "348px",
                "key": "example1",
                "code": 'import pandas as pd\nfrom mannager.forms import display_pandas\n\ndf = pd.DataFrame.from_dict(\n    {\n        "A": [1, 2, 3, 4],\n        "B": [5, 6, 7, 8],\n        "C": [9, 10, 11, 12],\n    }\n)\n\ndisplay_pandas(df)\n',
            }
        ],
    },
    "plotly-output": {
        ...
        "examples": [
            {
                ...
                "iframeHeight": "104px",
                "key": "example1",
                "code": "from mannager.forms import display_progress\n\ndisplay_progress()\n",
            },
            {
        ...
        "examples": [
            {
                ...
                "iframeHeight": "84px",
                "key": "example1",
                "code": 'from mannager.forms import display\n\ndisplay("Hello world!")\n',
            }
        ],
    },
}
