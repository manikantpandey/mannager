...
import mannager.ai as ai
import mannager.forms as af
from mannager.tasks import send_task
from mannager_internals.widgets.response_types import FileResponse

### 📌 mannager Forms is the easiest way to create dynamic forms that allow users to interact with your Python script.
...
### 📌 mannager AI is a powerful tool that allows you to prompt an AI model to extract data from images, generate text and more
...
### 📌 mannager Workflows is a powerful tool that allows you to store and share data between different stages of your workflow
