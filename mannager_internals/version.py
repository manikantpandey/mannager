...
from mannager_internals.utils import version as vsn_utils
...
class PackageVersionManager:
    def __init__(self, package_name: str) -> None:
        ...
        self.package_display_name = (
            package_name if package_name != "mannager" else "mannager Editor"
        )
...
def check_latest_version(package_name="mannager"):
