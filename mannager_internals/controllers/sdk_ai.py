...
import mannager_internals.utils.b64 as b64
from mannager_internals.repositories.ai import AiApiHttpClient
from mannager_internals.utils.string import to_snake_case
from mannager_internals.widgets.response_abc import mannagerctFileResponse

Prompt = Union[str, io.IOBase, pathlib.Path, mannagerctFileResponse]
...
class AiSDKController:
    ...
    def _make_messages(self, prompt: Prompt) -> List:
        ...
        if isinstance(prompt, mannagerctFileResponse):
            file = prompt.file
