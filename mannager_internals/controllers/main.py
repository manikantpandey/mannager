...
from mannager_internals.cloud_api import get_api_key_info, get_project_info
from mannager_internals.controllers.linters import check_linters
...
from mannager_internals.repositories.email import EmailRepository
from mannager_internals.repositories.execution import ExecutionFilter, ExecutionRepository
...
from mannager_internals.repositories.keyvalue import KVRepository
from mannager_internals.repositories.producer import ProducerRepository
...
from mannager_internals.repositories.roles import RolesRepository
from mannager_internals.repositories.tasks import TasksRepository
from mannager_internals.repositories.users import UsersRepository
...
from mannager_internals.utils.dot_mannager import TEST_DATA_FILE
from mannager_internals.utils.file import files_from_directory, module2path, path2module
from mannager_internals.utils.validate import validate_json
...
class MainController:
    ...
    def __init__(self, repositories: Repositories):
        ...
        RequirementsRepository.ensure("mannager")
        ensure_mannagerignore(Settings.root_path)
