...
from mannager_internals.entities.execution_context import HookContext, Request, Response
from mannager_internals.repositories.project.project import HookStage, ProjectRepository
