...
GIT_FOLDER = ".git"
mannager_IGNORE = ".mannagerignore"
mannager_TABLES_FILE = "mannager-tables.json"
...
def get_ignore_files(dir: Path):
    ...
    IGNOREFILE = dir.joinpath(mannager_IGNORE)
    git_path = dir.joinpath(GIT_FOLDER)
    mannager_path = dir.joinpath(DOT_mannager_FOLDER_NAME)
    ignored = [IGNOREFILE.name, GITIGNORE.name, mannager_path.name, git_path.name]
