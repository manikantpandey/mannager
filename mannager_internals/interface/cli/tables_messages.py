...
def dump_message(num_tables: int):
    if num_tables == 0:
        ...
        print(
            ...
            + Style.RESET_ALL
            + Style.BRIGHT
            + f"{num_tables} {tables} were dumped at {mannager_TABLES_FILE}\n\n"
            + Style.RESET_ALL
        )
...
def file_not_found_error_message():
    print(
        ...
        + Style.RESET_ALL
        + Style.BRIGHT
        + f"The file {mannager_TABLES_FILE} does not exist.\n\n"
        + Style.RESET_ALL
    )
...
def bad_json_error_message():
    print(
        ...
        + Style.RESET_ALL
        + Style.BRIGHT
        + f"The content in file {mannager_TABLES_FILE} is not in correct JSON format.\n\n"
        + Style.RESET_ALL
    )
...
def zod_error_message():
    print(
        ...
        + Style.RESET_ALL
        + Style.BRIGHT
        + f"The file {mannager_TABLES_FILE} is not formatted correctly. \n\n"
        + Style.RESET_ALL
    )
