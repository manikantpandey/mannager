...
from mannager_internals.cloud_api import create_build, update_build
...
def deploy():
    ...
    if not headers:
        print(
            "No project credentials found. Please run `mannager editor` and login via the web interface."
        )
        return
