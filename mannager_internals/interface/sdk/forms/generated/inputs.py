...
from mannager_internals.widgets.types import mannagerOption
from mannager_internals.widgets.response_types import FileResponse, PhoneResponse, AppointmentSlot
...
def read_checklist(label: str, options: List[mannagerOption], **kwargs) -> List[str]:
...
def read_dropdown(label: str, options: List[mannagerOption], **kwargs) -> str:
...
def read_multiple_choice(label: str, options: List[mannagerOption], **kwargs) -> Union[list, Any]:
