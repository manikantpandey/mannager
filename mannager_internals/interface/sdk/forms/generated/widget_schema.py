...
from mannager_internals.interface.sdk.forms.reactive import Reactive
from mannager_internals.widgets.library import *
from mannager_internals.widgets import Input, Output
...
class WidgetSchema:
  ...
  def read_checklist(self, label: str, options: List[mannagerOption], **kwargs):
  ...
  def read_dropdown(self, label: str, options: List[mannagerOption], **kwargs):
  ...
  def read_multiple_choice(self, label: str, options: List[mannagerOption], **kwargs):
