...
from mannager_internals.repositories.users import TestUsersRepository
...
class TestRequirementsApi(TestCase):
    ...
    def test_app_protected_by(self):
        ...
        TESTER_EMAIL = "tester@mannager.app"
        ADMIN_EMAIL = "admin@mannager.app"
        USER_EMAIL = "user@mannager.app"
