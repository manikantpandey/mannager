...
from mannager_internals.server.routes import access_control as ac_router
from mannager_internals.server.routes import ai as ai_router
from mannager_internals.server.routes import assets as assets_router
from mannager_internals.server.routes import env_vars as envvars_router
from mannager_internals.server.routes import executions as executions_router
from mannager_internals.server.routes import forms as forms_router
from mannager_internals.server.routes import hooks as hooks_router
from mannager_internals.server.routes import jobs as jobs_router
from mannager_internals.server.routes import linters as linters_router
from mannager_internals.server.routes import login as login_router
from mannager_internals.server.routes import logs as logs_router
from mannager_internals.server.routes import pysa as pysa_router
from mannager_internals.server.routes import requirements as requirements_router
from mannager_internals.server.routes import resources as resources_router
from mannager_internals.server.routes import roles as roles_router
from mannager_internals.server.routes import scripts as scripts_router
from mannager_internals.server.routes import stdio as stdio_router
from mannager_internals.server.routes import tasks as tasks_router
from mannager_internals.server.routes import web_editor as web_editor_router
from mannager_internals.server.routes import workflows as workflows_router
from mannager_internals.server.routes import workspace as workspace_router
