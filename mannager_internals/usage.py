...
from mannager_internals.credentials import get_credentials
from mannager_internals.environment import CLOUD_API_CLI_URL, SIDECAR_HEADERS, SIDECAR_URL
from mannager_internals.jwt_auth import USER_AUTH_HEADER_KEY, UserClaims
from mannager_internals.threaded import threaded
from mannager_internals.utils import get_local_python_version, get_local_user_id
from mannager_internals.utils.env import is_dev_env, is_test_env
from mannager_internals.utils.packages import get_local_package_version
...
def send_editor_usage(payload: Dict):
    ...
    data = {
        ...
        "mannagerVersion": str(get_local_package_version()),
    }
