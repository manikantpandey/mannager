...
from mannager_internals.utils.code import function_called_args, subscript_called_args
...
class EnvVarsRepository:
    ...
    @staticmethod
    def list() -> List[mannagerLibApiEditorEnvVarsModel]:
        values = dotenv_values(EnvVarsRepository.get_env_var_path())
        return [
            mannagerLibApiEditorEnvVarsModel.from_dict(
                {
                    "name": k,
                    "value": v,
                }
