...
from mannager_internals.contracts_generated import mannagerLibApiEditorEnvVarsModel
from mannager_internals.repositories.project.project import ProjectRepository, ScriptStage
from mannager_internals.services.env_vars import EnvVarsRepository
...
class TestEnvVarsRepository(TestCase):
    ...
    def test_load(self):
        var = mannagerLibApiEditorEnvVarsModel(name="key", value="value")
