...
from mannager_internals.interface.cli.editor import start_consumer
...
from mannager_internals.server.apps import get_cloud_app, get_local_app
...
class BaseWorkflowTest(BaseTest):
    def setUp(self) -> None:
        ...
        (self.root / DOT_mannager_FOLDER_NAME).mkdir(exist_ok=True)
